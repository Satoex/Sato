...
struct lanczos31UDT
{
   ...
   static T lanczos_sum_expG_scaled(const T& z)
   {
      ...
      static const T num[31] = {
         ...
         static_cast<T>(BOOST_MATH_HUGE_CONSTANT(T, 150, 3857598154693333600846539129354.783647)),
...
struct lanczos61UDT
{
   ...
   static T lanczos_sum(const T& z)
   {
      ...
      static const T d[61] = {
         ...
         static_cast<T>(BOOST_MATH_HUGE_CONSTANT(T, 150, 301342031656979076702313946827.961658905182634508217626783081241074250132289461989333465387)),
   ...
   static T lanczos_sum_expG_scaled(const T& z)
   {
      ...
      static const T d[61] = {
         ...
         static_cast<T>(BOOST_MATH_HUGE_CONSTANT(T, 150, -0.425399199286327802950259994834798733333721414442095221716122926637623478450472871269742436e-15)),
   ...
   static T lanczos_sum_near_2(const T& dz)
   {
      ...
      static const T d[60] = {
         ...
         static_cast<T>(BOOST_MATH_HUGE_CONSTANT(T, 150, 0.000507636621977556438232613333542864427109623356049335590894564220687567763620803789858345916)),
