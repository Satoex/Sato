...
T bessel_i0_imp(const T& x, const mpl::int_<64>&)
{
   ...
   if(x < 7.75)
   {
      ...
      static const T P[] = {
         ...
         BOOST_MATH_BIG_CONSTANT(T, 64, 2.33333333333377703400424216e-02),
...
T bessel_i0_imp(const T& x, const mpl::int_<113>&)
{
   ...
   if(x < 7.75)
   {
      ...
      static const T P[] = {
         ...
         BOOST_MATH_BIG_CONSTANT(T, 113, 2.3333333333333333333333333333881795230918e-02),
   ...
   else if(x < 15)
   {
      ...
      static const T P[] = {
         ...
         BOOST_MATH_BIG_CONSTANT(T, 113, 2.3333333333333333744261405400543564492074e-02),
