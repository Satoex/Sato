   ...
   BOOST_MATH_STD_USING
      if(x <= 1)
      {
         ...
         static const T P2[] =
         {
            ...
            BOOST_MATH_BIG_CONSTANT(T, 64, 3.660333462036966089410e-04),
      ...
      else
      {
         ...
         static const T Q[] =
         {
            ...
            BOOST_MATH_BIG_CONSTANT(T, 64, 1.773371397243333491569e+02),
   ...
   BOOST_MATH_STD_USING
      ...
      else
      {
         ...
         static const T P[] =
         {
            ...
            BOOST_MATH_BIG_CONSTANT(T, 113, 1.335663334588806892764139643950439733e+09),
