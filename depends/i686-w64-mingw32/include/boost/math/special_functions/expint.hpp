...
T expint_1_rational(const T& z, const mpl::int_<113>&)
{
   ...
   if(z <= 1)
   {
      ...
      static const T P[10] = {    
         ...
         BOOST_MATH_BIG_CONSTANT(T, 113, -0.340500302333438063940402160594523429e-9)
      };
      static const T Q[10] = {    
         BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
         BOOST_MATH_BIG_CONSTANT(T, 113, 0.426568823334942588160423015589537302),
...
void expint_i_imp_113a(T& result, const T& z, const Policy& pol)
{
   ...
   static const T Q[15] = {    
      ...
      BOOST_MATH_BIG_CONSTANT(T, 113, 0.382742953753485333207833344720070523e-12)
   };
