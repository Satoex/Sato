...
struct lanczos11 : public mpl::int_<60>
{
   ...
   static T lanczos_sum(const T& z)
   {
      ...
      static const T num[11] = {
         ...
         static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 60, 341986.3488721347032223333472763188768288)),
...
struct lanczos17m64 : public mpl::int_<64>
{
   ...
   static T lanczos_sum_near_2(const T& dz)
   {
      ...
      static const T d[16] = {
         ...
         static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 51.98768915202973863076166956576333443805)),
         ...
         static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, -0.3333876663062235617693516558976641009819e-13)),
...
struct lanczos24m113 : public mpl::int_<113>
{
   ...
   static T lanczos_sum(const T& z)
   {
      ...
      static const T denom[24] = {
         ...
         static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 113, 0.112400072333360768e22)),
   ...
   static T lanczos_sum_expG_scaled(const T& z)
   {
      ...
      static const T num[24] = {
         ...
         static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 113, 1165278.06807504975090675074910052763026564833951579556132333302952882101173607903881127542)),
         static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 113, 24024.759267256769471083727721827405338569868270133339485912486668586611981795179894572115)),
   ...
   static T lanczos_sum_near_2(const T& dz)
   {
      ...
      static const T d[23] = {
         ...
         static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 113, 0.410605371184590959139968810080063542546949719163227555918846829816144878123034343334284006e-25)),
      };
      T result = 0;
      T z = dz + 2;
      for(unsigned k = 1; k <= sizeof(d)/sizeof(d[0]); ++k)
