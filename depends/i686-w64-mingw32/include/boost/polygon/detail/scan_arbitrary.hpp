...
//     }
  ...
  public:
    ...
    static inline bool test_validate_scan(stream_type& stdcout) {
      ...
      input.clear();
      edges.clear();
      input.push_back(std::make_pair(half_edge(Point(-9850009+9853379, -286971+290340), Point(-12333469+9853379, -3214831+290340)), 0));
      ...
      input.clear();
      edges.clear();
      input.push_back(std::make_pair(half_edge(Point(-9850009, -286971), Point(-12333469, -3214831)), 0));
...
pts.push_back(Point(12959272, 7742961 )); pts.push_back(Point(12950981, 7746396 )); pts.push_back(Point(12944636, 7752741 )); pts.push_back(Point(12941201, 7761032 )); pts.push_back(Point(12941201, 7770007 )); pts.push_back(Point(12944636, 3334298 )); pts.push_back(Point(12947490, 7781780 ));
