Sato Core version *2.1.0* is now available!!
==============

  <https://github.com/SatoProject/Sato/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/SatoProject/Sato/commits/release_2.1.0>
