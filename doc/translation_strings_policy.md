...
This document provides guidelines for internationalization of the Sato Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sato_en.ts` remains unchanged.
