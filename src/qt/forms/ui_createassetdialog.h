...
public:
    ...
    void setupUi(QDialog *CreateAssetDialog)
    {
        if (CreateAssetDialog->objectName().isEmpty())
            CreateAssetDialog->setObjectName(QStringLiteral("CreateAssetDialog"));
        ...
        CreateAssetDialog->setWindowTitle(QStringLiteral("Asset Creation Form"));
        ...
        frameAssetData->setObjectName(QStringLiteral("frameAssetData"));
        ...
        assetTypeLabel->setObjectName(QStringLiteral("assetTypeLabel"));

        horizontalLayout_10->addWidget(assetTypeLabel);

        assetType = new QComboBox(frameAssetData);
        assetType->setObjectName(QStringLiteral("assetType"));
        ...
        assetFullName->setObjectName(QStringLiteral("assetFullName"));
        ...
        availabilityButton->setObjectName(QStringLiteral("availabilityButton"));
        ...
        labelVerifierStringErrorMessage->setObjectName(QStringLiteral("labelVerifierStringErrorMessage"));
        ...
        createAssetButton->setObjectName(QStringLiteral("createAssetButton"));
    ...
    {
        labelCoinControlFeatures->setText(QApplication::translate("CreateAssetDialog", "Coin Control Features", Q_NULLPTR));
        pushButtonCoinControl->setText(QApplication::translate("CreateAssetDialog", "Inputs...", Q_NULLPTR));
        labelCoinControlAutomaticallySelected->setText(QApplication::translate("CreateAssetDialog", "automatically selected", Q_NULLPTR));
        labelCoinControlInsuffFunds->setText(QApplication::translate("CreateAssetDialog", "Insufficient funds!", Q_NULLPTR));
        labelCoinControlQuantityText->setText(QApplication::translate("CreateAssetDialog", "Quantity:", Q_NULLPTR));
        labelCoinControlBytesText->setText(QApplication::translate("CreateAssetDialog", "Bytes:", Q_NULLPTR));
        labelCoinControlAmountText->setText(QApplication::translate("CreateAssetDialog", "Amount:", Q_NULLPTR));
        labelCoinControlLowOutputText->setText(QApplication::translate("CreateAssetDialog", "Dust:", Q_NULLPTR));
        labelCoinControlFeeText->setText(QApplication::translate("CreateAssetDialog", "Fee:", Q_NULLPTR));
        labelCoinControlAfterFeeText->setText(QApplication::translate("CreateAssetDialog", "After Fee:", Q_NULLPTR));
        labelCoinControlChangeText->setText(QApplication::translate("CreateAssetDialog", "Change:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBoxCoinControlChange->setToolTip(QApplication::translate("CreateAssetDialog", "If this is activated, but the change address is empty or invalid, change will be sent to a newly generated address.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxCoinControlChange->setText(QApplication::translate("CreateAssetDialog", "Custom change address", Q_NULLPTR));
        labelCoinControlChangeLabel->setText(QString());
        assetTypeLabel->setText(QString());
        assetNameLabel->setText(QApplication::translate("CreateAssetDialog", "Name:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        nameText->setToolTip(QApplication::translate("CreateAssetDialog", "A-Z 0-9 and . or _ as the second character", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        nameText->setPlaceholderText(QApplication::translate("CreateAssetDialog", "The name of the asset you would like to create", Q_NULLPTR));
        assetFullName->setText(QString());
        availabilityButton->setText(QApplication::translate("CreateAssetDialog", "Check Availabilty", Q_NULLPTR));
        addressLabel->setText(QApplication::translate("CreateAssetDialog", "Address:", Q_NULLPTR));
        addressText->setText(QString());
        addressText->setPlaceholderText(QApplication::translate("CreateAssetDialog", "The SATO address that will hold this asset (You must own this address). Leave blank to create a new address.", Q_NULLPTR));
        labelVerifierString->setText(QApplication::translate("CreateAssetDialog", "Verifier String:", Q_NULLPTR));
        lineEditVerifierString->setPlaceholderText(QApplication::translate("CreateAssetDialog", "Create a verifier string built from Qualifier names e.g (#KYC & #VALID). Leave blank to default to true", Q_NULLPTR));
        labelVerifierStringErrorMessage->setText(QApplication::translate("CreateAssetDialog", "Warning:", Q_NULLPTR));
        quantityLabel->setText(QApplication::translate("CreateAssetDialog", "Quantity:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        quantitySpinBox->setToolTip(QApplication::translate("CreateAssetDialog", "The number of assets that will be created", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        unitsLabel->setText(QApplication::translate("CreateAssetDialog", "Units:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        unitBox->setToolTip(QApplication::translate("CreateAssetDialog", "How divisble the assets will be (e.g. 8 = 1.00000000, 2 = 1.00)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        unitExampleLabel->setText(QApplication::translate("CreateAssetDialog", "e.g. 1", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        reissuableBox->setToolTip(QApplication::translate("CreateAssetDialog", "If the owner of this asset will be able to issue more assets in the future", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        reissuableBox->setText(QApplication::translate("CreateAssetDialog", "Reissuable", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ipfsBox->setToolTip(QApplication::translate("CreateAssetDialog", "Does this asset have an ipfs hash to go with it", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ipfsBox->setText(QApplication::translate("CreateAssetDialog", "Add IPFS/Txid Hash", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ipfsText->setToolTip(QApplication::translate("CreateAssetDialog", "The ipfs/txid hash that contains information about the asset", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ipfsText->setPlaceholderText(QApplication::translate("CreateAssetDialog", "The ipfs/txid hash that is associated with the asset being created (e.g. QmU4h365LYMHx...)", Q_NULLPTR));
        messageLabel->setText(QApplication::translate("CreateAssetDialog", "ERROR TEXT", Q_NULLPTR));
        labelFeeHeadline->setText(QApplication::translate("CreateAssetDialog", "Transaction Fee:", Q_NULLPTR));
        labelFeeMinimized->setText(QString());
        buttonChooseFee->setText(QApplication::translate("CreateAssetDialog", "Choose...", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        fallbackFeeWarningLabel->setToolTip(QApplication::translate("CreateAssetDialog", "Using the fallbackfee can result in sending a transaction that will take several hours or days (or never) to confirm. Consider choosing your fee manually or wait until you have validated the complete chain.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        fallbackFeeWarningLabel->setText(QApplication::translate("CreateAssetDialog", "Warning: Fee estimation is currently not possible.", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        buttonMinimizeFee->setToolTip(QApplication::translate("CreateAssetDialog", "collapse fee-settings", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        buttonMinimizeFee->setText(QApplication::translate("CreateAssetDialog", "Hide", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        labelCustomPerKilobyte->setText(QApplication::translate("CreateAssetDialog", "per kilobyte", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("CreateAssetDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for sato transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("CreateAssetDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for sato transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelMinFeeWarning->setText(QApplication::translate("CreateAssetDialog", "(read the tooltip)", Q_NULLPTR));
        radioSmartFee->setText(QApplication::translate("CreateAssetDialog", "Recommended:", Q_NULLPTR));
        radioCustomFee->setText(QApplication::translate("CreateAssetDialog", "C&ustom:", Q_NULLPTR));
        labelSmartFee->setText(QString());
        labelFeeEstimation->setText(QString());
        labelSmartFee2->setText(QApplication::translate("CreateAssetDialog", "(Smart fee not initialized yet. This usually takes a few blocks...)", Q_NULLPTR));
        labelSmartFee3->setText(QApplication::translate("CreateAssetDialog", "Confirmation time target:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        optInRBF->setToolTip(QApplication::translate("CreateAssetDialog", "Indicates that the sender may wish to replace this transaction with a new one paying higher fees (prior to being confirmed).", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        optInRBF->setText(QApplication::translate("CreateAssetDialog", "Request Replace-By-Fee", Q_NULLPTR));
        createAssetButton->setText(QApplication::translate("CreateAssetDialog", "Create Asset", Q_NULLPTR));
        clearButton->setText(QApplication::translate("CreateAssetDialog", "Clear", Q_NULLPTR));
        label->setText(QApplication::translate("CreateAssetDialog", "Balance:", Q_NULLPTR));
        labelBalance->setText(QApplication::translate("CreateAssetDialog", "123.456 SATO", Q_NULLPTR));
