...
public:
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        label2_repair_zap1->setObjectName(QStringLiteral("label2_repair_zap1"));
        ...
        label2_repair_reindex->setObjectName(QStringLiteral("label2_repair_reindex"));
    ...
    void retranslateUi(QWidget *RPCConsole)
    {
        ...
        label_repair_helptext->setText(QApplication::translate("RPCConsole", "The buttons below will restart the wallet with command-line options to recover missing transactions or rebuild corrupt blockchain files.", Q_NULLPTR));
        ...
        btn_zapwallettxes1->setText(QApplication::translate("RPCConsole", "Recover transactions", Q_NULLPTR));
        btn_reindex->setText(QApplication::translate("RPCConsole", "Rebuild index", Q_NULLPTR));
        label_repair_rescan->setText(QApplication::translate("RPCConsole", "-rescan: Rescan the blockchain files on disk for missing wallet transactions. (Short process)", Q_NULLPTR));
        label_repair_zap1->setText(QApplication::translate("RPCConsole", "-zapwallettxes=1: Delete all wallet transactions and recover them with a rescan. (Keeps metadata)", Q_NULLPTR));
        label2_repair_zap1->setText(QApplication::translate("RPCConsole", "Use to recover balance when transactions fail to broadcast to the network.", Q_NULLPTR));
        label_repair_reindex->setText(QApplication::translate("RPCConsole", "-reindex: Rebuild chain state and block index from the blk00*.dat files on disk. (Long process)", Q_NULLPTR));
        label2_repair_reindex->setText(QApplication::translate("RPCConsole", "Use after importing private keys or restoring a wallet.dat backup.", Q_NULLPTR));
