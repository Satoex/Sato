...
public:
    ...
    QPushButton *openSatoConfButton;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        satoAtStartup = new QCheckBox(tabMain);
        satoAtStartup->setObjectName(QStringLiteral("satoAtStartup"));

        verticalLayout_Main->addWidget(satoAtStartup);
        ...
        customFeeFeatures->setObjectName(QStringLiteral("customFeeFeatures"));
        ...
        darkModeCheckBox->setObjectName(QStringLiteral("darkModeCheckBox"));
        ...
        openSatoConfButton = new QPushButton(OptionsDialog);
        openSatoConfButton->setObjectName(QStringLiteral("openSatoConfButton"));
        openSatoConfButton->setAutoDefault(false);

        verticalLayout_Buttons->addWidget(openSatoConfButton);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        satoAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start %1 after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        satoAtStartup->setText(QApplication::translate("OptionsDialog", "&Start %1 on system login", Q_NULLPTR));
        ...
        customFeeFeatures->setText(QApplication::translate("OptionsDialog", "Enable fee control features", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Sato client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Sato network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Sato network through a separate SOCKS5 proxy for Tor hidden services.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        darkModeCheckBox->setText(QApplication::translate("OptionsDialog", "Enable Dark Mode", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        openSatoConfButton->setToolTip(QApplication::translate("OptionsDialog", "Open the %1 configuration file from the working directory.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        openSatoConfButton->setText(QApplication::translate("OptionsDialog", "Open Configuration File", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
