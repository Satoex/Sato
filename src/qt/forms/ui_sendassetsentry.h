...
public:
    ...
    SatoAmountField *payAmount_s;

    void setupUi(QStackedWidget *SendAssetsEntry)
    {
        if (SendAssetsEntry->objectName().isEmpty())
            SendAssetsEntry->setObjectName(QStringLiteral("SendAssetsEntry"));
        ...
        assetAmountLabel->setObjectName(QStringLiteral("assetAmountLabel"));
        ...
        memoLabel->setObjectName(QStringLiteral("memoLabel"));
        ...
        ownershipWarningMessage->setObjectName(QStringLiteral("ownershipWarningMessage"));

        gridLayout->addWidget(ownershipWarningMessage, 8, 1, 1, 1);

        assetBoxLabel = new QLabel(SendCoins);
        assetBoxLabel->setObjectName(QStringLiteral("assetBoxLabel"));
        ...
        payAssetAmount->setObjectName(QStringLiteral("payAssetAmount"));
        ...
        assetSelectionBox->setObjectName(QStringLiteral("assetSelectionBox"));
        ...
        payAmount_s = new SatoAmountField(SendCoins_AuthenticatedPaymentRequest);
    ...
    void retranslateUi(QStackedWidget *SendAssetsEntry)
    {
        ...
        SendCoins->setToolTip(QApplication::translate("SendAssetsEntry", "This is an asset payment", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendAssetsEntry", "A message that was attached to the sato: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Sato network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        assetAmountLabel->setText(QString());
        memoLabel->setText(QApplication::translate("SendAssetsEntry", "Memo:", Q_NULLPTR));
        amountLabel->setText(QApplication::translate("SendAssetsEntry", "Amount:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        addAsLabel->setToolTip(QApplication::translate("SendAssetsEntry", "Enter a label for this address to add it to the list of used addresses", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labellLabel->setText(QApplication::translate("SendAssetsEntry", "&Label:", Q_NULLPTR));
        ownershipWarningMessage->setText(QString());
        assetBoxLabel->setText(QApplication::translate("SendAssetsEntry", "Asset:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendAssetsEntry", "The Sato address to send the payment to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        addressBookButton->setToolTip(QApplication::translate("SendAssetsEntry", "Choose previously used address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        addressBookButton->setText(QString());
        addressBookButton->setShortcut(QApplication::translate("SendAssetsEntry", "Alt+A", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        pasteButton->setToolTip(QApplication::translate("SendAssetsEntry", "Paste address from clipboard", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        pasteButton->setText(QString());
        pasteButton->setShortcut(QApplication::translate("SendAssetsEntry", "Alt+P", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        deleteButton->setToolTip(QApplication::translate("SendAssetsEntry", "Remove this entry", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        deleteButton->setText(QString());
        messageLabel->setText(QApplication::translate("SendAssetsEntry", "Message:", Q_NULLPTR));
        payToLabel->setText(QApplication::translate("SendAssetsEntry", "Pay &To:", Q_NULLPTR));
        administratorCheckbox->setText(QApplication::translate("SendAssetsEntry", "Transfer Administrator Asset", Q_NULLPTR));
        memoBox->setPlaceholderText(QApplication::translate("SendAssetsEntry", "Put a IPFS or Txid hash here to be sent with the asset transfer", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        SendCoins_UnauthenticatedPaymentRequest->setToolTip(QApplication::translate("SendAssetsEntry", "This is an unauthenticated payment request.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        payToLabel_is->setText(QApplication::translate("SendAssetsEntry", "Pay To:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        deleteButton_is->setToolTip(QApplication::translate("SendAssetsEntry", "Remove this entry", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        deleteButton_is->setText(QString());
        memoLabel_is->setText(QApplication::translate("SendAssetsEntry", "Memo:", Q_NULLPTR));
        amountLabel_is->setText(QApplication::translate("SendAssetsEntry", "A&mount:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        SendCoins_AuthenticatedPaymentRequest->setToolTip(QApplication::translate("SendAssetsEntry", "This is an authenticated payment request.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        payToLabel_s->setText(QApplication::translate("SendAssetsEntry", "Pay To:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        deleteButton_s->setToolTip(QApplication::translate("SendAssetsEntry", "Remove this entry", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        deleteButton_s->setText(QString());
        memoLabel_s->setText(QApplication::translate("SendAssetsEntry", "Memo:", Q_NULLPTR));
        amountLabel_s->setText(QApplication::translate("SendAssetsEntry", "A&mount:", Q_NULLPTR));
