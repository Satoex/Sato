...
public:
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        payAmount = new SatoAmountField(SendCoins);
        ...
        payAmount_is = new SatoAmountField(SendCoins_UnauthenticatedPaymentRequest);
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setToolTip(QApplication::translate("SendCoinsEntry", "The fee will be deducted from the amount being sent. The recipient will receive less satos than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setText(QApplication::translate("SendCoinsEntry", "S&ubtract fee from amount", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the sato: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Sato network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labellLabel->setText(QApplication::translate("SendCoinsEntry", "&Label:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The Sato address to send the payment to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
