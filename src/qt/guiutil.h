...
#ifndef SATO_QT_GUIUTIL_H
#define SATO_QT_GUIUTIL_H
...
/** Utility functions used by the Sato Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "sato:" URI into recipient object, return true on successful parsing
