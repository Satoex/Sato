...
QT_MOC_LITERAL(3, 37, 20), // "on_btnImport_clicked"
QT_MOC_LITERAL(4, 58, 22) // "on_btnGenerate_clicked"

    },
    "MnemonicDialog\0on_btnCancel_clicked\0"
    "\0on_btnImport_clicked\0on_btnGenerate_clicked"
};
...
void MnemonicDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_btnImport_clicked(); break;
...
const QMetaObject MnemonicDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_MnemonicDialog.data,
      qt_meta_data_MnemonicDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MnemonicDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MnemonicDialog.stringdata0))
        return static_cast<void*>(const_cast< MnemonicDialog*>(this));
