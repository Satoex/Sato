...
QT_MOC_LITERAL(5, 65, 24), // "customFeeFeaturesChanged"
QT_MOC_LITERAL(6, 90, 19) // "hideTrayIconChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "coinControlFeaturesChanged\0"
    "customFeeFeaturesChanged\0hideTrayIconChanged"
};
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->customFeeFeaturesChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->hideTrayIconChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (OptionsModel::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::customFeeFeaturesChanged)) {
                *result = 2;
                return;
            }
        }
