...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(SatoUnits::SATO),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->splBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->splBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(SatoUnits::formatWithUnit(unit, balance, false, SatoUnits::separatorAlways));
    ui->labelUnconfirmed->setText(SatoUnits::formatWithUnit(unit, unconfirmedBalance, false, SatoUnits::separatorAlways));
    ui->labelImmature->setText(SatoUnits::formatWithUnit(unit, immatureBalance, false, SatoUnits::separatorAlways));
    ui->labelTotal->setText(SatoUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, SatoUnits::separatorAlways));
    ui->labelWatchAvailable->setText(SatoUnits::formatWithUnit(unit, watchOnlyBalance, false, SatoUnits::separatorAlways));
    ui->labelWatchPending->setText(SatoUnits::formatWithUnit(unit, watchUnconfBalance, false, SatoUnits::separatorAlways));
    ui->labelWatchImmature->setText(SatoUnits::formatWithUnit(unit, watchImmatureBalance, false, SatoUnits::separatorAlways));
    ui->labelWatchTotal->setText(SatoUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, SatoUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("SATO")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the SATO balance grid from expanding and looking terrible when asset balance is hidden
