...
#include "config/sato-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatSatoURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + SatoUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatSatoURI(info));
}
