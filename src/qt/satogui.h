...
/**
  Sato GUI main class. This class represents the main window of the Sato UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SatoGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SatoGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~SatoGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a sato wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
