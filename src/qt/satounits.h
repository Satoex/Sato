...
#ifndef SATO_QT_SATOUNITS_H
#define SATO_QT_SATOUNITS_H
...
/** Sato unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SatoUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SatoUnits(QObject *parent);

    /** Sato units.
      @note Source: https://en.sato.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SATO,
...
typedef SatoUnits::Unit SatoUnit;

#endif // SATO_QT_SATOUNITS_H
