...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<SatoAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_sato-qt -platform xcb      # Linux
//     src/qt/test/test_sato-qt -platform windows  # Windows
//     src/qt/test/test_sato-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = SatoUnits::formatWithUnit(unit, balance, false, SatoUnits::separatorAlways);
    ...
    // Amount input
    SatoAmountField* amountInput = receiveCoinsDialog.findChild<SatoAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: sato:")) != -1);
