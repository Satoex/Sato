...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, SatoUnits::SeparatorStyle separators=SatoUnits::separatorStandard) const;
