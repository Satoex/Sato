...
void WalletView::setSatoGUI(SatoGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? SatoGUI::HD44_ENABLED : _walletModel->hdEnabled() ? SatoGUI::HD_ENABLED : SatoGUI::HD_DISABLED);
