...
#ifndef SATO_SCRIPT_STANDARD_H
#define SATO_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_SATO_ASSET script that carries data
    /** SATO END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a sato address
 */
...
/**
 * Generate a Sato scriptPubKey for the given CTxDestination. Returns a P2PKH
