...
/* test/.libs/lt-test_sato_hash.c - temporary wrapper executable for .libs/test_sato_hash.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2

   The test/test_sato_hash program cannot be directly executed until all the libtool
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# test/test_sato_hash - temporary wrapper script for .libs/test_sato_hash.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2\n", f);
  fputs ("#\n", f);
  fputs ("# The test/test_sato_hash program cannot be directly executed until all the lib", f);
  fputs ("tool\n", f);
  ...
  fputs ("    echo \"test_sato_hash.exe:test/test_sato_hash:$LINENO: libtool wrapper (GNU ", f);
  fputs ("libtool) 2.4.6 Debian-2.4.6-2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_sato_hash.exe:test/test_sato_hash:$LINENO: newargv[$lt_dump_arg", f);
  fputs ("s_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_sato_hash.exe:test/test_sato_hash:$LINENO: newargv[0]: $pro", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_sato_hash.exe'\n", f);
