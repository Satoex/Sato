...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler spl tx
        CScript splTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut splOut(1*COIN, splTransfer);
        ...
        mutTxTest1.vout.emplace_back(splOut);
        ...
        mutTxTest2.vout.emplace_back(splOut);
        ...
        mutTxTest3.vout.emplace_back(splOut);
        ...
        mutTxTest4.vout.emplace_back(splOut);
        ...
        mutTxTest5.vout.emplace_back(splOut);
        ...
        mutTxTest6.vout.emplace_back(splOut);
        ...
        mutTxTest7.vout.emplace_back(splOut);
        ...
        mutTxTest8.vout.emplace_back(splOut);
