...
#ifndef SATO_TEST_SCRIPTNUM10_H
#define SATO_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Sato Core 0.10.0, for cross-comparison.
 */
public:
