...
#ifndef SATO_WALLET_WALLETDB_H
#define SATO_WALLET_WALLETDB_H
...
public:
    ...
    static const int VERSION_HD_CHAIN_SATOIT = 2;
    ...
    inline void SerializationOp(Stream& s, Operation ser_action)
    {
        ...
        READWRITE(seed_id);
        if (this->nVersion >= VERSION_HD_CHAIN_SATOIT) {
