...
find ${DISTNAME}/bin -type f -executable -exec ../sato/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../sato/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/sato/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/sato/depends/SDKs/MacOSX10.11.sdk.tar.gz
