...
class BIP66Test(SatoTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # satod is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and satod produces more specific reject
            # reasons.
