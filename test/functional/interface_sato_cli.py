...
class TestSatoCli(SatoTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `sato-cli getinfo`")
        ...
        self.log.info("Compare responses from `sato-cli -getinfo` and the RPCs data is retrieved from.")
