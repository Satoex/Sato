...
By default, satod will dump mempool on shutdown and
...
class MempoolPersistTest(SatoTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give satod a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent satod from writing mempool.dat to disk. Verify that `savemempool` fails")
