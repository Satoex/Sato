...
class DecodeScriptTest(SatoTestFramework):
    ...
    def decodescript_script_pub_key(self):
        public_key = '03b0da749730dc9b4b1f4a14d6902877a92541f5368778853d9c4a0cb7802dcfb2'
        push_public_key = '21' + public_key
        public_key_hash = '11695b6cd891484c2d49ec5aa738ec2b2f893333'
    ...
    def decodescript_assets(self):
        """Test decoding SATO_ASSETS scripts (regtest scripts)."""
        ...
        assert_equal('OP_DUP OP_HASH160 35a8d9b395f1594e2cf3e06e6ec357d1da897368 OP_EQUALVERIFY OP_CHECKSIG OP_SATO_ASSET 1a72766e710954455354415353455400e40b54020000000800000075', result['asm'])
