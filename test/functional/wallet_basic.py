...
class WalletTest(SatoTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 SATO from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 SATO with subtract fee from amount
        ...
        # Sendmany 10 SATO with subtract fee from amount
