...
class TxnMallTest(SatoTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 SATO:
        ...
        # First: use raw transaction API to send 1240 SATO to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 SATO coin each
        ...
        # Node0's balance should be starting balance, plus 50SATO for another
        ...
        # Node0's total balance should be starting balance, plus 100SATO for 
